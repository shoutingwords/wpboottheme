                    ...
                    <div class="thumbnail post-thumbnail">
                      <div class="thumb-wrapper">
                        <img src="images/post-thumbnail-02.jpg" alt="Alternate Text" class="img-responsive">
                        <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                      </div>
                      <div class="caption">
                        <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                    ...
                    <div class="thumbnail post-thumbnail">
                      <div class="thumb-wrapper">
                        <img src="images/post-thumbnail-03.jpg" alt="Alternate Text" class="img-responsive">
                        <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                      </div>
                      <div class="caption">
                        <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                    ...
                    <div class="thumbnail post-thumbnail">
                      <div class="thumb-wrapper">
                        <img src="images/post-thumbnail-04.jpg" alt="Alternate Text" class="img-responsive">
                        <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                      </div>
                      <div class="caption">
                        <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                    ...
                    <div class="thumbnail post-thumbnail">
                      <div class="thumb-wrapper">
                        <img src="images/post-thumbnail-05.jpg" alt="Alternate Text" class="img-responsive">
                        <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                      </div>
                      <div class="caption">
                        <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                    ...
                    <div class="thumbnail post-thumbnail">
                      <div class="thumb-wrapper">
                        <img src="images/post-thumbnail-06.jpg" alt="Alternate Text" class="img-responsive">
                        <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                      </div>
                      <div class="caption">
                        <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
