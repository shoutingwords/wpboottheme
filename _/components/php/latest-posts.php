                  ...
                  <h3 class="latest-post-label">Latest Posts</h3>
                      ...
                      <div class="thumbnail post-thumbnail">
                        <div class="thumb-wrapper">
                          <img src="images/post-thumbnail-02.jpg" alt="Alternate Text" class="img-responsive hidden-print">
                          <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                        </div>
                        <div class="caption">
                      ...
                      <div class="thumbnail post-thumbnail">
                        <div class="thumb-wrapper">
                          <img src="images/post-thumbnail-04.jpg" alt="Alternate Text" class="img-responsive hidden-print">
                          <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                        </div>
                        <div class="caption">
                          <h3>WordPress 3.7 release brings automatic updates, better search and other core enhancements</h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                          tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                          quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                          consequat.</p>
                      ...
                      <div class="thumbnail post-thumbnail">
                        <div class="thumb-wrapper">
                          <img src="images/post-thumbnail-05.jpg" alt="Alternate Text" class="img-responsive hidden-print">
                          <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                        </div>
                        <div class="caption">
                          <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                      ...
                      <div class="thumbnail post-thumbnail">
                        <div class="thumb-wrapper">
                          <img src="images/post-thumbnail-03.jpg" alt="Alternate Text" class="img-responsive hidden-print">
                          <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                        </div>
                        <div class="caption">
                          <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
                      ...
                      <div class="thumbnail post-thumbnail">
                        <div class="thumb-wrapper">
                          <img src="images/post-thumbnail-06.jpg" alt="Alternate Text" class="img-responsive hidden-print">
                          <a class="cat-label" href="category.php"><span class="label label-default category-label">Category Name</span></a>
                        </div>
                        <div class="caption">
                          <h3>The Quick Brown Fox Jumped over the Lazy Dogs</h3>
